...
<div id="frap">
	<div id="ftr"><div class="br">
        ...
        <div class="e"><div class="l"><a href="<?php bloginfo('url'); ?>">Home</a> &nbsp;|&nbsp; <a href="http://www.dataquick.com/about/careers/" target="_blank">Careers</a> &nbsp;|&nbsp; <a href="http://www.dataquick.com/about/consumer-privacy/" target="_blank">Consumer Privacy</a> &nbsp;|&nbsp; <a href="http://www.dataquick.com/about/privacy/" target="_blank">Privacy</a> &nbsp;|&nbsp; <a href="http://www.dataquick.com/about/terms/" target="_blank">Terms of Use</a><br />Copyright &copy; <?php echo date('Y'); ?> <a href="http://www.dataquick.com" target="_blank">DataQuick</a>. All Rights Reserved<br/><small>In Attorney states, including but not limited to, CT, DE, GA, LA, MA, NC, SC, VT and WV, services may not include full closings, title search, abstracting or examination, title opinions, deed preparation or any other service that constitutes the practice of law under the laws of that state.  In all other states, services are performed in compliance with all applicable state regulations and statutes.</small></div>
        <div class="r so">
        <ul>
