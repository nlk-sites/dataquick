...
wp_enqueue_style('jqueryui-smoothness', get_bloginfo('template_url') .'title/jqueryui/jquery-ui-1.10.1.custom.min.css');
wp_enqueue_script('branchlocator', get_bloginfo('template_url') .'title/branchloc.js', array('jquery-ui-accordion'), false, true);
